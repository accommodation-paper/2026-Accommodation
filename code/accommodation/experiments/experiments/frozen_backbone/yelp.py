...
def run_frozen_backbone_yelp_experiment(args):
	set_seed(42)
	...
	run_experiment("YELP", args, dataset.vocab_size, train_loader, val_loader, instantiate_gru_linear_classifier, instantiate_gru_accommodation_classifier)
