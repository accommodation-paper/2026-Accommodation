...
def run_frozen_backbone_agnews_experiment(args):
	set_seed(42)
	...
	run_experiment("AGNews", args, dataset.vocab_size, train_loader, val_loader, instantiate_gru_linear_classifier, instantiate_gru_accommodation_classifier)
