...
def run_frozen_backbone_mnist_experiment(args):
	set_seed(42)
	...
	run_experiment(
		...
		instantiate_backbone_model=instantiate_mnist_linear_classifier,
		instantiate_head_model=instantiate_mnist_accommodation_classifier,
	)
