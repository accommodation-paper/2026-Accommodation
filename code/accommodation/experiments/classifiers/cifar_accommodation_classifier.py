...
def instantiate_cifar_accommodation_classifier(args):
    return Cifar10AccommodationClassifier(neutral_potents=args['neutral-potents'], negative_potents=args['negative-potents'], num_classes=args['num-classes'], latent_dim=args['latent-dim'], plasticity=args["plasticity"], num_potents_per_class=args["num-potents-per-class"])
