...
def run_accommodation_mnist_experiment(args):
    set_seed(42)
    ...
    train_dataset = MNISTDataset(args['data-path'], train=True, transform=train_transform)
    val_dataset = MNISTDataset(args['data-path'], train=False, transform=test_transform)
