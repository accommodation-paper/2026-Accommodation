...
from accommodation.experiments.classifiers.cifar_linear_classifier import instantiate_cifar_accommodation_classifier
...
def run_linear_cifar_experiment(args):
    set_seed(42)
    ...
    run_experiment("MNIST", args, train_loader, val_loader, instantiate_cifar_accommodation_classifier)